...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 259, 226))
...
"")
        ...
        self.verticalLayout_14 = QVBoxLayout(self.page_test)
        self.verticalLayout_14.setObjectName(u"verticalLayout_14")
        self.frame_4 = QFrame(self.page_test)
        self.frame_4.setObjectName(u"frame_4")
        palette2 = QPalette()
        brush13 = QBrush(QColor(255, 14, 86, 255))
        brush13.setStyle(Qt.SolidPattern)
        palette2.setBrush(QPalette.Active, QPalette.WindowText, brush13)
        brush14 = QBrush(QColor(0, 170, 255, 255))
        ...
        brush15 = QBrush(QColor(255, 255, 0, 255))
        brush15.setStyle(Qt.SolidPattern)
        palette2.setBrush(QPalette.Active, QPalette.ToolTipText, brush15)
        ...
        palette2.setBrush(QPalette.Inactive, QPalette.ToolTipText, brush15)
        ...
        palette2.setBrush(QPalette.Disabled, QPalette.ToolTipText, brush15)
        ...
        font9 = QFont()
        font9.setFamily(u"Adobe Arabic")
        ...
        self.frame_5 = QFrame(self.page_test)
        ...
        self.page_test2 = QWidget()
        self.page_test2.setObjectName(u"page_test2")
        self.verticalLayout_18 = QVBoxLayout(self.page_test2)
        self.verticalLayout_18.setObjectName(u"verticalLayout_18")
        self.frame1 = QFrame(self.page_test2)
        self.frame1.setObjectName(u"frame1")
        self.verticalLayout_23 = QVBoxLayout(self.frame1)
        ...
        self.frame_div_content_2 = QFrame(self.frame_8)
...
"border-radius: 5px;")
        ...
        self.verticalSlider_2 = QSlider(self.frame_7)
        ...
        self.verticalScrollBar_2 = QScrollBar(self.frame_7)
...
"")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 282, 226))
...
"}")
        ...
        self.horizontalScrollBar_2 = QScrollBar(self.frame_7)
        self.horizontalScrollBar_2.setObjectName(u"horizontalScrollBar_2")
        sizePolicy5.setHeightForWidth(self.horizontalScrollBar_2.sizePolicy().hasHeightForWidth())
        self.horizontalScrollBar_2.setSizePolicy(sizePolicy5)
...
"")
        ...
        self.commandLinkButton_2 = QCommandLinkButton(self.frame_7)
...
"}")
        ...
        self.horizontalSlider_2 = QSlider(self.frame_7)
        ...
        self.horizontalLayout_18 = QHBoxLayout(self.frame2)
        self.horizontalLayout_18.setObjectName(u"horizontalLayout_18")
        self.frame_41 = QFrame(self.frame2)
        self.frame_41.setObjectName(u"frame_41")
        self.verticalLayout_25 = QVBoxLayout(self.frame_41)
        self.verticalLayout_25.setObjectName(u"verticalLayout_25")
        self.frame_71 = QFrame(self.frame_41)
        self.frame_71.setObjectName(u"frame_71")
        self.frame_71.setMinimumSize(QSize(0, 60))
        self.horizontalLayout_15 = QHBoxLayout(self.frame_71)
        self.horizontalLayout_15.setObjectName(u"horizontalLayout_15")
        self.horizontalLayout_15.setContentsMargins(30, -1, -1, -1)
        ...
        self.frame_61 = QFrame(self.frame_41)
        self.frame_61.setObjectName(u"frame_61")
        self.horizontalLayout_17 = QHBoxLayout(self.frame_61)
        self.horizontalLayout_17.setObjectName(u"horizontalLayout_17")
        self.frame_21 = QFrame(self.frame_61)
        ...
        self.frame_51 = QFrame(self.frame2)
        self.frame_51.setObjectName(u"frame_51")
        self.verticalLayout_24 = QVBoxLayout(self.frame_51)
        self.verticalLayout_24.setObjectName(u"verticalLayout_24")
        self.frame_81 = QFrame(self.frame_51)
        self.frame_81.setObjectName(u"frame_81")
        self.frame_81.setMinimumSize(QSize(0, 60))
        self.horizontalLayout_20 = QHBoxLayout(self.frame_81)
        self.horizontalLayout_20.setObjectName(u"horizontalLayout_20")
        self.horizontalLayout_20.setContentsMargins(30, -1, -1, -1)
        ...
        self.verticalLayout_23.addWidget(self.frame2)


        self.verticalLayout_18.addWidget(self.frame1)

        self.stackedWidget.addWidget(self.page_test2)
...
"}")
        ...
        self.dial.valueChanged.connect(self.label_5.setNum)
        self.dial_3.valueChanged.connect(self.label_12.setNum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title_bar_top.setText(QCoreApplication.translate("MainWindow", u"page_test2, Main Window - Base", None))
        ...
        self.labelBoxBlenderInstalation_2.setText(QCoreApplication.translate("MainWindow", u"Hello Hello", None))
        self.lineEdit_2.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Your Password", None))
        self.pushButton_2.setText(QCoreApplication.translate("MainWindow", u"Open Blender", None))
        self.labelVersion_4.setText(QCoreApplication.translate("MainWindow", u"Ex: C:Program FilesBlender FoundationBlender 2.82 blender.exe", None))
        ...
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Dial control 1", None))
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"0", None))
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Dial control 1", None))
