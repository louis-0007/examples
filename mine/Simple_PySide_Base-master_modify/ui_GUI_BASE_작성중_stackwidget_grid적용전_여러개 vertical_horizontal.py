...
################################################################################
## Form generated from reading UI file 'GUI_BASE_�ۼ���_stackwidget_grid������_������ vertical_horizontaliWdzlS.ui'
##
...
"border-radius:20px;")
        ...
        self.pushButton_start.setMinimumSize(QSize(150, 50))
        font8 = QFont()
...
"}")
        ...
        self.pushButton_stop = QPushButton(self.frame_6)
        self.pushButton_stop.setObjectName(u"pushButton_stop")
        self.pushButton_stop.setMinimumSize(QSize(150, 50))
...
"}")
        ...
        self.verticalLayout_16.addWidget(self.pushButton_stop)
        ...
        self.pushButton_save_config = QPushButton(self.frame_5)
        self.pushButton_save_config.setObjectName(u"pushButton_save_config")
        self.pushButton_save_config.setMinimumSize(QSize(50, 80))
...
"	border: 2px solid rgb(43, 50, 61);\n"
"}")
        self.pushButton_save_config.setIcon(icon3)

        self.gridLayout_11.addWidget(self.pushButton_save_config, 2, 2, 1, 1)
        ...
        self.labelVersion_7.setMinimumSize(QSize(0, 25))
        self.labelVersion_7.setBaseSize(QSize(0, 10))
        self.labelVersion_7.setStyleSheet(u"\n"
"	border-radius: 3px;\n"
...
"	padding-left: 10px;")
        ...
        self.gridLayout_8.addWidget(self.labelVersion_7, 0, 0, 1, 1)

        self.gridLayout_7 = QGridLayout()
        self.gridLayout_7.setObjectName(u"gridLayout_7")
        self.gridLayout_7.setHorizontalSpacing(15)
        self.gridLayout_7.setContentsMargins(-1, -1, -1, 0)
        self.pushButton_config1 = QPushButton(self.groupBox_2)
...
"	border: 2px solid rgb(43, 50, 61);\n"
"}")
        self.pushButton_config1.setIcon(icon3)
...
"}")
        ...
        self.gridLayout_11.addWidget(self.groupBox_2, 2, 1, 1, 1)
...
"border-bottom-color: rgb(255, 0, 0);")
        ...
        self.labelVersion_6.setMinimumSize(QSize(0, 25))
        self.labelVersion_6.setStyleSheet(u"\n"
"	border-radius: 3px;\n"
"	border: 2px solid rgb(35, 35, 45);\n"
"	padding-left: 10px;")
        self.labelVersion_6.setLineWidth(1)
        self.labelVersion_6.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.labelVersion_6.setMargin(0)

        self.gridLayout_10.addWidget(self.labelVersion_6, 0, 0, 1, 1)

        self.gridLayout_6 = QGridLayout()
        self.gridLayout_6.setObjectName(u"gridLayout_6")
        self.gridLayout_6.setContentsMargins(-1, -1, -1, 0)
        self.pushButton_config = QPushButton(self.groupBox)
...
"	border: 2px solid rgb(43, 50, 61);\n"
"}")
        self.pushButton_config.setIcon(icon3)
...
"}")
        ...
        self.frame_title_wid_2 = QFrame(self.frame_5)
        ...
        self.gridLayout_11.addWidget(self.frame_title_wid_2, 1, 0, 1, 3)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelVersion_7.setText(QCoreApplication.translate("MainWindow", u"3", None))
        ...
        self.labelVersion_6.setText(QCoreApplication.translate("MainWindow", u"10", None))
        self.pushButton_config.setText(QCoreApplication.translate("MainWindow", u"\uc124\uc815", None))
        self.lineEdit_5.setPlaceholderText(QCoreApplication.translate("MainWindow", u"10", None))
